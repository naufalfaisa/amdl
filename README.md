...
```
4. Decryption happens during download, reducing memory usage for large files.
5. MV download support.
6. Interactive search with arrow-key navigation:
```bash
...
```
4. Select specific tracks from an album:
```bash
